  ...
  return (
    <S.Container>
      ...
      <S.body>
        ...
        <Box>
          <S.title style={{ textAlign: 'center', marginBottom: 20 }} >Cartão Virtual</S.title>
          ...
          {placas && (
            <VStack mt={8} space={2}>
              ...
              <Selection itens={placas} itemSelected={h => setPlacaSelected(h)} />
            </VStack>
          )}
          ...
          {getPlaca ? (
            ...
            >
              ...
              <HStack mb={6} justifyContent={'space-between'}>
                ...
                <S.title style={{ color: '#fff' }} >Placa: {placaSelected}</S.title>
              </HStack>
              ...
              <HStack alignItems={'flex-end'} justifyContent={'space-between'} w={'full'} >
                <Box>
                  <S.text style={{ color: '#fff' }} >VÁLIDO ATÉ {getPlaca.dataValidade}</S.text>
